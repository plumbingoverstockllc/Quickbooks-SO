...
REM window is up.
"%PY%" -m PyInstaller --noconfirm --onefile --windowed --name "DMQuotes" --icon "DMQuotes.ico" --splash "splash.png" %COLLECT% --add-data "Logo_New.png;." --add-data "Shimira_Labs.png;." --add-data "DMQuotes.ico;." --add-data "vendor_pricing.json;." app.py
